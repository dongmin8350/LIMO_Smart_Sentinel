...
static const _Options_type_support_symbol_names_t _Options_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, instant_messaging_interfaces, msg, Options)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, instant_messaging_interfaces, msg, Options)),
  }
};
...
{
  return &::instant_messaging_interfaces::msg::rosidl_typesupport_cpp::Options_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, instant_messaging_interfaces, msg, Options)() {
  return get_message_type_support_handle<instant_messaging_interfaces::msg::Options>();
}
