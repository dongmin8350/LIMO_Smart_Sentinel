...
class YoloNode(LifecycleNode):
    ...
    def __init__(self) -> None:
        ...
        self.result_publisher = self.create_publisher(Image, '/yolo/image', 10)
    ...
    def image_cb(self, msg: Image) -> None:
        ...
        if self.enable:
            ...
            # YOLO 결과 이미지 publish (박스, 라벨 등 오버레이)  직접추가 11/25 (아래 3줄)
            result_frame = results.plot()  # ultralytics의 plot() 함수 사용
            result_msg = self.cv_bridge.cv2_to_imgmsg(result_frame, encoding='bgr8')
