...
bool instant_messaging_interfaces__msg__options__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("instant_messaging_interfaces.msg._options.Options", full_classname_dest, 49) == 0);
  }
  instant_messaging_interfaces__msg__Options * ros_message = _ros_message;
  {  // question
...
{
  /* NOTE(esteve): Call constructor of Options */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("instant_messaging_interfaces.msg._options");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Options");
