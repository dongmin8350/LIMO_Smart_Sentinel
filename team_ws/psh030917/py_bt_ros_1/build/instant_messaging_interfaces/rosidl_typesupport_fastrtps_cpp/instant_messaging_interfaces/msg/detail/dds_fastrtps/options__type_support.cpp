...
#include "instant_messaging_interfaces/msg/detail/options__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = instant_messaging_interfaces::msg::Options;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const instant_messaging_interfaces::msg::Options *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<instant_messaging_interfaces::msg::Options *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Options__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const instant_messaging_interfaces::msg::Options *>(
...
static size_t _Options__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Options(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Options__callbacks = {
...
static rosidl_message_type_support_t _Options__handle = {
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_instant_messaging_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<instant_messaging_interfaces::msg::Options>()
{
  return &instant_messaging_interfaces::msg::typesupport_fastrtps_cpp::_Options__handle;
}
